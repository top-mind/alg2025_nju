...
\def\a{1}
\node[bnode,"$s$" {left}]  (s) at ({-\a*sqrt(3)},0) {$0$};
\node[bnode,"$t$" {above}] (t) at (0,\a) {$2$};
\node[bnode,"$x$" {above}] (x) at ({\a*2},\a) {$5$};
\node[bnode,"$y$" {below}] (y) at (0,-\a) {$4$};
\node[bnode,"$z$" {below}] (z) at ({\a*2},-\a) {$7$};
\path
